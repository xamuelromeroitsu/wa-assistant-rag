...
|---|---|---|
| `POST /api/generate` | Generar la respuesta con contexto (H3) | [ollama-api](..//apis/01-ollama-api.md) |
| `POST /api/embeddings` | Vectores de los fragmentos en ingesta (H4) | [ollama-api](..//apis/01-ollama-api.md) |
| `GET /api/tags` | Validar que el modelo elegido exista (H5) | [ollama-api](..//apis/01-ollama-api.md) |
...
Intervinientes y decisiones registradas en [flujo de datos](../arquitectura/02-flujo-datos.md).
...
Podman es daemonless y compatible con `docker-compose.yml`; el proyecto usa Podman por defecto pero es portable a Docker. Justificación completa en [ADR](../arquitectura/03-adr.md).

## Criterios técnicos del MVP

- **Lenguaje:** JavaScript (Node.js, ESM), sin framework web en el núcleo; el "API" HTTP es mínimo.
- **Pruebas:** unitarias para handlers, ingesta y búsqueda; fixture de documentos de prueba ([testing](../guias/testing.md)).
