...
Y un conjunto de criterios de aceptación (**Criterios de "terminado" funcionales**) que deben cumplirse para considerar la historia completa. Los criterios técnicos transversales viven en el [Definition of Done](../processes/definition-of-done.md) y la estrategia de pruebas en [testing](../guides/testing.md).
...
| Historia | Requisito funcional base | RNF principal (ver [scope](02-mvp-scope.md)) | Testing (ver [testing](../guides/testing.md)) |
|---|---|---|---|
